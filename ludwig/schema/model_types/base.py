...
from ludwig.schema.cross_validation import CrossValidationConfig, CrossValidationField
...
class ModelConfig(schema_utils.BaseMarshmallowConfig, ABC):
    ...
    cross_validation: Optional[CrossValidationConfig] = CrossValidationField().get_default_field()
